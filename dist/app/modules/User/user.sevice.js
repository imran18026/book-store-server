...
const createAdmin = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield bcrypt.hash(data.password, Number(config_1.default.saltRounds));
    data.password = hashedPassword;
    const result = yield prisma_1.default.user.create({ data });
    return result;
});
const createEditor = (data) => __awaiter(void 0, void 0, void 0, function* () {
    data.role = client_1.UserRole.EDITOR;
    const hashedPassword = yield bcrypt.hash(data.password, Number(config_1.default.saltRounds));
    data.password = hashedPassword;
    const result = yield prisma_1.default.user.create({ data });
    return result;
